...
public class Deletepackage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String packageid = request.getParameter("deletepid");
		String name = request.getParameter("packagename");
	    try { 
	    	Statement statement = con.createStatement();
			String deletequery = "DELETE FROM package WHERE PID='"+packageid+"' AND packagename='"+name+"';";
		    statement.executeUpdate(deletequery);
		    response.sendRedirect("./dashboard/deletepackage.jsp");
		}catch(Exception e){
