          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="package">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="addpackage.jsp" class="nav-link px-3 active">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
           <form action="./Addpackage" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputFirstname">PID</label>
                        <input type="text"  class="form-control" id="packageid" name="pid" placeholder="Package Id" required="" oninvalid="this.setCustomValidity('Package ID is mandatory filed ')"oninput="setCustomValidity('')" >
                       
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Package name</label>
                        <input type="text" class="form-control" id="packagename" name="packagename" placeholder="Package name" required="" oninvalid="this.setCustomValidity('Package name is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Price</label>
                        <input type="number" class="form-control" id="packagePrice" name="packagePrice" placeholder="Package price" required="" oninvalid="this.setCustomValidity('Package price is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputAddressLine1">Description</label>
                        <input type="text" class="form-control" id="packagedescription" name="description" placeholder="Description" required="" oninvalid="this.setCustomValidity('Description is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
                <div class="form-group row">
                    
                    <div class="col-sm-6">
                        <label for="inputAddressLine2">Image Location</label>
                        <input type="file" style="margin-top: 30px;" id="myfile" name="imagefile" required="" oninvalid="this.setCustomValidity('Image is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
                
                <button type="submit" class="btn btn-primary px-4 my-3 float-right">Add</button>
            </form>
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span> Bookings Table
              </div>
              <div class="card-body">
      	...
      	String checkuserquery = "SELECT * from package;";
		try {
