          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="gallery">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="addgallery.jsp" class="nav-link px-3 active">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
           ...
           <form action="./Addgallery" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="" name="gid" placeholder="Gallery Id" required="" oninvalid="this.setCustomValidity('Gallery ID is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Gallery name</label>
                        <input type="text" class="form-control" id="" name="galleryname" placeholder="Gallery name" required="" oninvalid="this.setCustomValidity('Name is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="file" style="margin-top: 30px;" id="myfile" name="galleryimage" required="" oninvalid="this.setCustomValidity('Image is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
