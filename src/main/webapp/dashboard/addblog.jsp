          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="blog">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="addblog.jsp" class="nav-link px-3 active">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
                      <span>Add Blog</span>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
           <form action="../Addblog" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputFirstname">Blog Name</label>
                        <input type="text" class="form-control" id="" name="blogname" placeholder="Name" required="" oninvalid="this.setCustomValidity('Blog Name is mandatory filed')"oninput="setCustomValidity('')">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Blog Description</label>
                        <input type="text" class="form-control" id="" name="blogdescription" placeholder="Description" required="" oninvalid="this.setCustomValidity('Blog Description is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="file" style="margin-top: 30px;" id="myfile" name="blogimage" required="" oninvalid="this.setCustomValidity('Image is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span> Blog Table
              </div>
              <div class="card-body">
      	...
      	String checkuserquery = "SELECT * from blog;";
		try {
