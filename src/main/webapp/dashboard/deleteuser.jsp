          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="user">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="deleteuser.jsp" class="nav-link px-3 active">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
           ...
           <form action="./Deleteuser" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="" name="username" placeholder="User Name" required="" oninvalid="this.setCustomValidity('Username is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Mobile Number</label>
                        <input type="number" class="form-control" id="" name="mobilenumber" placeholder="Mobile Number" required="" oninvalid="this.setCustomValidity('Mobile number is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputAddressLine1">Email</label>
                        <input type="text" class="form-control" id="" name="usermail" placeholder="User Email" required="" oninvalid="this.setCustomValidity('Email is mandatory filed ')"oninput="setCustomValidity('')">
                    </div>
      	...
      	String checkuserquery = "SELECT name,mobilenumber,email from User;";
		try {
