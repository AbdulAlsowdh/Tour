          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="package">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="deletepackage.jsp" class="nav-link px-3 active">
                      <span class="me-2"
                        ><i class="bi bi-speedometer2"></i
                      ></span>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
           <form action="./Deletepackage" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputFirstname">PID</label>
                        <input type="text" class="form-control" id="" name="deletepid" placeholder="Package Id" required>
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Package name</label>
                        <input type="text" class="form-control" id="" name="packagename" placeholder="Package name" required>
                    </div>
                </div>
